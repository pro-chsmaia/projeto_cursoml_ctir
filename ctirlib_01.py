...
def dividirTreinoTeste(df, dfQtLinhas):
    """
        ...
        ### Parâmetros
        :df: DataFrame
        :dfQtLinhas: quantidade de linhas para amostra
        ### Retorno
...
def gerarMatrizTfidf(X_treino, X_teste, minimoDf=1):
    """
        Gerar matriz tf-idf das variáveis independentes
        ---
        ### Parâmetros
        :X_treino: Variável independente de treino
        :X_teste: Variável independente de teste
        ### Retorno
...
def treinarModeloSGD(X_treino_tfidf, y_treino, X_teste_tfidf, y_teste, sgd_loss, retornaClassificador=False):
    ...
    """
        ...
        ---
        ### Parâmetros
        :X_treino_tfidf: Matriz tf-idf da variável independente de treino
        :y_treino: Variável dependente de treino
        :X_teste_tfidf: Matriz tf-idf da variável independente de treino
        :y_teste: Variável dependente de teste
        :sgd_loss: função de perda
        :retornaClassificador: inclui classificador no retorno da função
        ### Retorno
        :return: acurácia do classificador e classificador [opcional]
    """
...
def gerarDfMedidasAcuracia(listaAcuraciasDfClasseTexto, listaAcuraciasDfClasseTextoRuido):
    """
        Gerar DataFrame com medidas de acurácia
        ---
        ### Parâmetros
        :listaAcuraciasDfClasseTexto: lista de acurácias em base SEM ruído.
        :listaAcuraciasDfClasseTextoRuido: lista de acurácias em base COM ruído.
        ### Retorno
        :return: DataFrame com medidas de acurária.
    """
    import pandas as pd
